...
int main( int argc, char* argv[]){
	...
	iForestObject->computeMassMatrix_woLCA(distance_matrix);
	...
	for(cutoff_percent = step_size; cutoff_percent < max_percent+step_size; cutoff_percent+=step_size){
		...
		//std::string sortedDensityRank_path = path_to_results+"_wolcaMBD_sortedDensityRank.csv";
		...
		std::string runningTimeFile_path = path_to_results+"_wolcaMBD_runningTime.csv";
		...
		//std::string clusterCenterFile_path = path_to_results+"_wolcaMBD_clusterCenters.csv";
		//MPCObj->write_ClusterCenters(clusterCenterFile_path);		
		
		std::string cIdFile_path = path_to_results+"_wolcaMBD_cId.csv";
		MPCObj->write_cId(cIdFile_path);
		
		//std::string haloIdFile_path = path_to_results+"_wolcaMBD_haloId.csv";
