...
int main( int argc, char* argv[]){
	...
	//iForestObject->computeMassMatrix_NxN(massMatrix);
	iForestObject->efficient_massMatrix_NxN(massMatrix);
	...
	std::string runningTimeFile_path = path_to_results+"_fast_massBased_runningTime.csv";
	...
	std::string file_path =path_to_results+"_fast_massBased_AScores.csv";
	...
	write_aScoreFORallK_toFile(aScore, path_to_results+"_fast_massBased_AScores.csv");
	
	//write_massMatrix_toFile(massMatrix,path_to_results+"_fast_massMatrix.csv");
	return 0;
}
